...
const tests = [tetotestMeta, sociopathMeta, romanticMeta, travelMeta];
              ...
              className={`
                ...
                ${
                  test.id === 'sociopathtest'
                    ...
                    : test.id === 'traveltest'
                    ? 'bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 border-blue-100 hover:from-blue-100 hover:to-blue-300'
