  ...
  return (
    <div className="max-w-2xl mx-auto py-12 px-6">
      ...
      <ul className="list-disc pl-6 mb-4 text-sm">
        ...
        <li>단, 구글 애드센스 등 광고를 위해 외부 서비스의 쿠키가 사용될 수 있습니다. 해당 내용은 구글의 <a className="underline text-blue-700" href="https://policies.google.com/technologies/ads?hl=ko" target="_blank" rel="noopener noreferrer">광고정책</a>을 참고 바랍니다.</li>
      </ul>
