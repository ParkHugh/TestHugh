...
export default function TravelTestResultPage() {
  ...
  // type이 아직 undefined일 수 있으니 안전하게 처리!
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 to-yellow-50 flex flex-col items-center justify-center px-4 py-8">
      <Head>
        ...
        <meta property="og:image" content={result.image.startsWith('/images') ? `https://test-hugh.co.kr${result.image}` : result.image} />
      ...
      <div className="flex flex-col items-center w-full">
        ...
        <button
          onClick={() => router.push("/traveltest")}
