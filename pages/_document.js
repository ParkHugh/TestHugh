  ...
  return (
    <Html lang="ko">
      <Head>
        ...
        {/* 메인 설명, 키워드 */}
        <meta name="description" content="심리테스트, 성격유형, 밸런스게임! 1분 만에 나의 성향을 Test 休에서 확인해보세요." />
        ...
        <meta property="og:description" content="최신 성격유형 심리테스트 밸런스게임 결과를 1분 만에!" />
        ...
        {/* 구글/네이버 사이트 소유 인증 */}
        <meta name="google-site-verification" content="uMEZwGxIiTzAForBPhkOiGzFOyJLCtYO2xm48DPfF4Q" />
