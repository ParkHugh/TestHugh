...
const faqList = [
  ...
  {
    q: "Q. 친구에게 테스트를 보내고 싶은데, 공유 방법이 있나요?",
    a: "모든 테스트 결과 페이지 하단 공유 버튼을 눌러 카카오톡, 인스타그램, 링크 복사 등으로 손쉽게 보낼 수 있습니다.",
  },
  {
    q: "Q. 왜 ‘Test 休(휴)’라는 이름인가요?",
    a: "'휴(休)'는 '쉼'을 뜻하는 한자로, 바쁜 일상 속 잠깐의 쉬어가는 심리적 공간이 되길 바라는 마음에서 지은 이름입니다. 그리고 개발자인 제 이름이 Hugh 휴 입니다 🫠",
  },
  {
