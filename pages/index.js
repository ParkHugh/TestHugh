  ...
  return (
    <div className="bg-[#fcf8ee] min-h-screen flex flex-col">
      ...
      <Head>
        ...
        <meta name="description" content=" 성격유형, 테토 테스트, 소시오패스테테스, 러너 유형, 여행성향 모든 심리테스트를 한 곳에서! Test 休에서 새로운 나를 발견하세요!" />
        <meta name="keywords" content="성격유형,성격검사, 심리검사, 테토 테스트, 소시오패스테스트 러너 유형, 여행성향, 에겐남, 여행 MBTI, 심리 테스트, 무료테스트, 밸런스게임, MBTI, 직장 테스트" />
